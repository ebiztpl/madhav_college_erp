...
foreach ($students as $student) {
    ...
    <?php if (!empty($certificate[0]->background_image)) { ?>
        ...
        <div style="position:absolute; z-index:99999; font-weight:bold; top:39%; left:40%; font-size:20px;">
            <?php echo $student->firstname.' '.$student->middlename.' '.$student->lastname; ?>
        </div>

        <div style="position:absolute; z-index:99999; font-weight:bold; top:45%; left:18%; font-size:20px;">
        ...
        <div style="position:absolute; z-index:99999; font-weight:bold;top: 33%;left: 78%;; font-size:20px;">
             <?php echo set_value('date', date($this->customlib->getSchoolDateFormat())); ?>
             
        </div>

        <div style="position:absolute; z-index:99999; font-weight:bold;top: 33%; left: 15%; font-size:20px;">
             <?php echo $student->admission_no; ?>
             
        </div>

        <div style="position:absolute; z-index:99999; font-weight:bold; top:52.5%; left:32%; font-size:20px;">
        <?php echo $student->class; ?>
             
        </div>


        <div style="position:absolute; z-index:99999; font-weight:bold; top:52.5%; left:68%; font-size:20px;">        
