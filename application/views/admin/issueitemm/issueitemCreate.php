        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form  action="<?php echo site_url('admin/issueitemm/add') ?>"  id="issueitem" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            <div class="row">
...
<script type="text/javascript">
    ...
    function availableQuantity(item_id) {
        if (item_id != "") {
            ...
            $.ajax({
                type: "GET",
                url: base_url + "admin/itemm/getAvailQuantity",
    ...
    function getIssueUser(usertype) {
        ...
        $.ajax({
            type: "POST",
            url: base_url + "admin/issueitemm/getUser",
