...
<div class="content-wrapper">
    ...
    $this->session->unset_userdata('msg'); ?> </div> <?php }?>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('student/dropoutstudentslist') ?>" method="post" class="">
...
if (array_key_exists($reason_id, $disable_reason)) {
            ...
            ?></span>
                                                            <div class="fee_detail_popover" style="display: none"><?php echo $student['drop_note']; ?></div></td>
                                                            <td><?php echo date("d-m-Y", strtotime($student['dropout_at']));?></td>
