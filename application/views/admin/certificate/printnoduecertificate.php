...
foreach ($students as $student) {
    ...
    <?php if (!empty($certificate[0]->background_image)) { ?>
        ...
        <div style="position:absolute; z-index:99999; font-weight:bold; top:32.5%; left:69%; font-size:20px;">
            <?php echo $student->firstname.' '.$student->middlename.' '.$student->lastname; ?>
        </div>

        <div style="position:absolute; z-index:99999; font-weight:bold; top:37.5%; left:30%; font-size:20px;">
        ...
        <div style="position:absolute; z-index:99999; font-weight:bold;top: 16.8%; left: 22.5%; font-size:12px;">
             <?php echo $student->admission_no; ?>
             
        </div>

        <div style="position:absolute; z-index:99999; font-weight:bold; top:42%; left:15%; font-size:20px;">
        ...
        <div style="position:absolute; z-index:99999; font-weight:bold; top:16.5%; left:83%; font-size:13px;">        
        <?php echo date("d-m-Y"); ?>
        </div>
