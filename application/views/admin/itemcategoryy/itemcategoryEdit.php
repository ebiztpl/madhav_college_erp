            ...
            <?php if ($this->rbac->hasPrivilege('item_category', 'can_add') || $this->rbac->hasPrivilege('item_category', 'can_edit')) { ?> 
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form action="<?php echo site_url("admin/itemcategoryy/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Useful Life In Years</label><small class="req"> *</small>
                                    <input autofocus="" id="itemcategory" name="usefullife" placeholder="" type="number" class="form-control"  value="<?php echo set_value('usefullife', $itemcategory['usefullife']); ?>" />
                                    <span class="text-danger"><?php echo form_error('usefullife'); ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Depreciation Percentage In Numbers</label><small class="req"> *</small>
                                    <input autofocus="" id="itemcategory" name="dep_per" placeholder="" type="number" class="form-control"  value="<?php echo set_value('dep_per', $itemcategory['dep_per']); ?>" />
                                    <span class="text-danger"><?php echo form_error('dep_per'); ?></span>
                                </div>
                                        ...
                                        <?php if (empty($categorylist)) {
                                            ...
                                            foreach ($categorylist as $category) {
                                                ...
                                                <tr>                                               
                                                    ...
                                                    <td class="mailbox-name"><?php echo $category['usefullife'] ?> Years</td>
                                                    <td class="mailbox-name"><?php echo $category['dep_per'] ?> %</td>
                                                    <td class="mailbox-name"><?php echo $category['description'] ?></td>
                                                    <td class="mailbox-date pull-right no-print">
                                                        <?php if ($this->rbac->hasPrivilege('item_category', 'can_edit')) { ?> 
                                                            <a href="<?php echo base_url(); ?>admin/itemcategoryy/edit/<?php echo $category['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                                <i class="fa fa-pencil"></i>
                                                            </a>
                                                        <?php } if ($this->rbac->hasPrivilege('item_category', 'can_delete')) { ?> 
                                                            <a href="<?php echo base_url(); ?>admin/itemcategoryy/delete/<?php echo $category['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
