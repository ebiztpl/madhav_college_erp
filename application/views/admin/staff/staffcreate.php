...
?>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" id="addhar_no" name="addhar_no" class="form-control" value="<?php echo set_value('addhar_no'); ?>">
                                ...
                                <div class="col-md-3"><div class="form-group"><label for="pan_no" class="control-label">PAN Card No.</label><small class="req"> *</small>
                                        <input type="text" id="pan_no" name="pan_no" class="form-control" value="<?php echo set_value('pan_no'); ?>"><span class="text-danger"><p><?php echo form_error('pan_no'); ?></p></span>
                                    </div>
                                </div>         
                                ...
                                <div class="col-md-3"><div class="form-group"><label for="nominee" class="control-label">Nominee Name</label><small class="req"> </small>
                                        <input type="text" id="nominee" name="nominee" class="form-control" value="<?php echo set_value('nominee'); ?>"><span class="text-danger"></span>
                                    </div>
                                </div> 
                                ...
                                <div class="col-md-3"><div class="form-group"><label for="nominee_number" class="control-label">Nominee Contact Number</label><small class="req"> </small>
                                        <input type="number" id="nominee_number" name="nominee_number" class="form-control" value="<?php echo set_value('nominee_number'); ?>"><span class="text-danger"></span>
                                    </div>
                                </div> 
                                ...
                                <!--  , date of reliving , nominee ka number  while staff add -->
                                    ...
                                    <div class="box-body">
                                        <div class="tshadow mb25 bozero">
                                            ...
                                            <div class="row around10">
                                                <?php if ($sch_setting->staff_epf_no) {?>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="cpf_no" name="cpf_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('cpf_no') ?>"  />
                                                        </div>
                                                    </div>
                                                ...
                                                <?php }?>
                                                <div class="col-md-4"><div class="form-group"><label for="date_of_reliving" class="control-label">Date of Reliving</label><small class="req"> </small>
