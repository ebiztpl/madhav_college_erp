...
class disable_reason_model extends MY_Model
{
    ...
    public function add($data)
    {
        ...
        public function check_disable_reason_check($str)
        {
            $reason = $this->security->xss_clean($str);
            if ($reason != "") {
                ...
                $isexist = $this->check_disable_reason_check_exists($reason, $id);
                if ($isexist) {
                    $this->form_validation->set_message('check_disable_reason_check', $this->lang->line('record_already_exist'));
                    return false;
                }
            }
            return true;
        ...
        public function check_disable_reason_check_exists($reason, $id)
        {
