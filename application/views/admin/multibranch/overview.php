                            ...
                            <tbody>
                                ...
                                if (!empty($school_students)) {
                                    ...
                                    foreach ($school_students as $school_key => $school_value) {
                                        ...
                                        ?>
                                <tr>
                                    <td width="26%"><a class="open_detail" style="cursor:pointer" data-id="<?php echo str_replace(' ', '_', $school_value['name']) ?>" id="close"><?php echo $school_value['name']; ?></a></td>
                                ...
                                <tr>
                                <td colspan="6" style="display:none" id="<?php echo str_replace(' ', '_', $school_value['name']) ?>">
                                <!-- custom byb ritk -->
                                 <?php foreach($school_value['data'] as $key => $val){ ?>
                                    <table class="table table-hover mb5 table-striped table-bordered">
                                        <thead>
                                        <tr class="text-center">
                                            ...
                                            <th class="text-center" >Balance Fees</th>
                                        </tr>    
                                        </thead>
                                        <tbody>
                            
                                            <?php  foreach( $val as $key => $sec){  ?>
                                        <tr class="text-center">
                                            <td class="text-center"><?= $sec['section'] ?></td>
                                            <td class="text-center"><?= $sec['count'] ?></td>
                                            <td class="text-center"><?= $currency_symbol.amountFormat($sec['total_fees']) ?></td>
                                            <td class="text-center"><?= $currency_symbol.amountFormat($sec['total_paid']) ?></td>
                                            <td class="text-center"><?= $currency_symbol.amountFormat($sec['total_balance']) ?></td>
                                        </tr>    
                                        <?php  }   ?>
                                        </tbody>
