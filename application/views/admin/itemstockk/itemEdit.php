    ...
    ?>
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/itemstockk/edit/<?php echo $item['id'] ?>"  id="itemstockform" name="itemstockform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
...
if ($item['date'] != '0000-00-00') {
    ...
    ?>
        ...
        echo set_value('date', $item_date);}?>" readonly="readonly" />
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Depreciation Value</label><small class="req"> </small>
                                    <input id="date" name="depreciation_value" placeholder="" type="text" class="form-control "  value="<?php echo set_value('depreciation_value', $item['depreciation_value']); ?>"  />
                                    <span class="text-danger"><?php echo form_error('depreciation_value'); ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Depreciation Amortisation</label><small class="req"> </small>
                                    <input id="date" name="depreciation_amortisation" placeholder="" type="text" class="form-control "  value="<?php echo set_value('depreciation_amortisation', $item['depreciation_amortisation']); ?>"  />
                                    <span class="text-danger"><?php echo form_error('depreciation_amortisation'); ?></span>
                                </div>

                                <div class="form-group" id="form_sessionmodal_body">
                                </div><br><br>
...
if ($items['description'] == "") {
        ...
        ?>
                                                ...
                                                <td class="mailbox-name text-right">
                                                    <?php echo $items['depreciation_value']; ?>
                                                </td>
                                                <td class="mailbox-name text-right">
                                                    <?php echo $items['depreciation_amortisation']; ?>
                                                </td>
            ...
            ?>
                                                        <a href="<?php echo base_url(); ?>admin/itemstockk/download/<?php echo $items['attachment'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>">
                                                            <i class="fa fa-download"></i>
                                                        </a>
                                                    <?php }
        ?>

                                                    <a href="<?php echo base_url(); ?>admin/itemstockk/edit/<?php echo $items['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" data-record-id="<?php echo $items['quantity']; ?>" title="<?php echo $this->lang->line('edit'); ?>">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>

                                                    <a href="<?php echo base_url(); ?>admin/itemstockk/delete/<?php echo $items['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
    ...
    $(document).ready(function () {
        ...
        function populateItem(item_id_post, item_category_id_post) {
            if (item_category_id_post != "") {
                ...
                $.ajax({
                    type: "GET",
                    url: base_url + "admin/itemstockk/getItemByCategory",
        ...
        $(document).on('change', '#item_id', function (e) {
            ...
            $.ajax({
            type: "GET",
            url: base_url + "admin/itemstockk/getItemunit",
     ...
     $(document).ready(function (event) {
         ...
         $.ajax({
             ...
             success: function(data) {
                ...
                $('#ritik_custom').val(<?php echo $item['session']; ?>).change();
             },
