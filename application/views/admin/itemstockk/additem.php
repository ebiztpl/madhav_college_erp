        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo base_url() ?>admin/itemm"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" >
                        <div class="box-body">
...
if ($items['description'] == "") {
        ...
        ?>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    <a href="<?php echo base_url(); ?>admin/itemm/add/<?php echo $items['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('add'); ?>"><i class="fa fa-plus"></i></a>

                                                    <a href="<?php echo base_url(); ?>admin/itemm/edit/<?php echo $items['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>"><i class="fa fa-pencil"></i></a>

                                                    <a href="<?php echo base_url(); ?>admin/itemm/delete/<?php echo $items['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
