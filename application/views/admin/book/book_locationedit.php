    ...
    <section class="content">
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/book/booklocationupdate"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
...
if (isset($error_message)) {
    ...
    <input type="hidden" name="id" value="<?= $fet->id ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="location" name="location" placeholder="" type="text" class="form-control"  value="<?= $fet->location ?>" />
                                    <span class="text-danger"><?php echo form_error('location'); ?></span>
                                </div>
                           
                                 <?php if($fet->refrence_location == 0){ ?>
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" name="description" placeholder="" rows="3" placeholder=""  maxlength="250"><?= $fet->description ?></textarea>
                    ...
                    <div class="box-body">
                        ...
                        <!-- <table class="table table-hover table-striped table-bordered example">
                                    ...
                                    <tr>
                                        ...
                                        <th class="white-space-nowrap" style="width:10%">Description</th>
                                ...
                                <?php $i=0 ;foreach($book_location as $dat ){ $i++ ; ?>
                                        ...
                                        <tr>
                                        <td colspan="2" style="text-align:center;" ><?=  $dat->location ?></td>
                                        </tr>      
                                        
                                       
                                       <?php foreach($booksub_location as $sub1 ){ ?>
                                      <tr>
                                        ...
                                        <table class="table table-hover table-striped table-bordered ">
                                            ...
                                            <tr>
                                             <td colspan="2" style="text-align:center;"><?= $sub1->location ?></td>
                                            </tr>  
                                            ...
                                            ?>
                                            <?php foreach($booksubsub_location as $sub2 ){ ?>
                                            ...
                                            ?>
                                                ...
                                                <td  style="width:70%"  style="text-align:center;">
                                                                               <table class="table table-hover table-striped table-bordered" >
                                                                       <tr>
                                                                       <td colspan="2" style="text-align:center;" >  <?= $sub2->location ?></td>
                                                                       </tr>  
                                                                        <?php foreach($booksubsubsub_location as $sub3 ){ ?>
                                                                        <tr>
                                                                            <td style="width:55%">
                                                                            <?= $sub3->location ?>
                                                                            <td>
                                        ...
                                        <td class="white-space-nowrap" style="width:20%">
