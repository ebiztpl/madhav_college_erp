                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Edit Accession No.</h3>
                        </div><!-- /.box-header -->
                        <form id="form1" action="<?php echo base_url() ?>admin/book/editbookparticular/<?=$id?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
...
if (isset($error_message)) {
    ...
    <input  type="hidden" name="idd" value="<?php echo set_value('id', $editbook->id); ?>" >
                                ...
                                <input id="isbn_no" name="book_no" placeholder="" type="text" class="form-control check_book"  value="<?= $editbook->bookcode ?>" />
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Location</label>
                                 ...
                                 <input  name="book_location" placeholder="" type="hidden" class="form-control abcd0"   value="<?= $editbook->location ?>" />
                                 <span class="text-danger"><?php echo form_error('book_location'); ?></span>
                                <span class="text-danger"></span>
                            </div>

                            <div class="form-group text-center">
                                <span class="prevlocation"><?= $z?></span>
                            </div>
...
<script>
    $(document).on('keyup', '.check_book', function () {
        ...
        if(($check_value.length > 0) && (<?= $editbook->bookcode ?> != $check_value)){
            $.ajax({
