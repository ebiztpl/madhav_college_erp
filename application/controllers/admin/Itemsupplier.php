...
class Itemsupplier extends Admin_Controller
{
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() == false) {
           ...
           $insert_id = $this->itemsupplier_model->add($data);
   ...
   $unit= NULL;
   $income_expense_type_id = $this->config->item('inventory_supplier_add_ladger_type');
   $income_expense_group_id = $this->config->item('inventory_supplier_add_group');;
   $type = 0;
   $type_name = 'inventory_supplier_create';
