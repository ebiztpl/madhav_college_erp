    ...
    ?>
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/itemstockk"  id="itemstockform" name="itemstockform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
...
if (set_value('store_id') == $itemstore['id']) {
    ...
    ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="date" name="depreciation_value" placeholder="" type="text" class="form-control "  value="<?php echo set_value('depreciation_value'); ?>"  />
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="date" name="depreciation_amortisation" placeholder="" type="text" class="form-control "  value="<?php echo set_value('depreciation_amortisation'); ?>"  />
...
if ($items['description'] == "") {
        ...
        ?>
            ...
            ?>
                                                        <a href="<?php echo base_url(); ?>admin/itemstockk/download/<?php echo $items['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>">
                                                            <i class="fa fa-download"></i>
                                                        </a>
                                                    <?php }
        ?>
                                                    <?php if ($this->rbac->hasPrivilege('item_stock', 'can_edit')) {?>
                                                        <a href="<?php echo base_url(); ?>admin/itemstockk/edit/<?php echo $items['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
