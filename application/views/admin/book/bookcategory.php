    ...
    <section class="content">
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/book/bookcategory"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
...
if (isset($error_message)) {
    ...
    <input type="hidden" name="id" value="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="category" name="category" placeholder="" type="text" class="form-control"  value="" />
