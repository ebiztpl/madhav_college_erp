            ...
            <div class="col-md-12">
                ...
                <div class="nav-tabs-custom theme-shadow">
                    <ul class="nav nav-tabs pull-right">
                        <li class="pull-left header w-xs-100">Send WhatsApp</li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                 <label>WhatsApp Template Title</label>
                                            ...
                                            <div class="form-group">
                                                <label>WhatsApp Template Name</label> <small class="req">*</small>
...
foreach ($send_through_list as $key => $send_through_list_value) {
    ?>
                                                <?php if($send_through_list_value == "SMS"){ ?>
                                                    <label class="checkbox-inline">
                                                    <input type="checkbox" value="sms" name="group_send_by[]"> Whatsapp</label>
...
foreach ($send_through_list as $key => $send_through_list_value) {
    ?>
                                                <?php if($send_through_list_value == "SMS"){ ?>
                                                    <label class="checkbox-inline">
                                                    <input type="checkbox" value="sms" name="individual_send_by[]"> Whatsapp</label>
...
foreach ($send_through_list as $key => $send_through_list_value) {
    ?>
                                                <?php if($send_through_list_value == "SMS"){ ?>
                                                    <label class="checkbox-inline">
                                                    <input type="checkbox" value="sms" name="class_send_by[]"> Whatsapp</label>
...
foreach ($send_through_list as $key => $send_through_list_value) {
    ?>
                                                <?php if($send_through_list_value == "SMS"){ ?>
                                                    <label class="checkbox-inline">
                                                    <input type="checkbox" value="sms" name="birthday_send_by[]"> Whatsapp</label>
    ...
    $('#template_id').change(function(){
        ...
        $.ajax({
            ...
            success:function(response){
                $('#group_title').val(response.data.template_name);
...
<script type="text/javascript">
    ...
    var template_id =  $('#individual_template_id').val();
        ...
        $.ajax({
            ...
            dataType: 'json',
            success:function(response){
                $('#individual_title').val(response.data.template_name);
...
<script type="text/javascript">
    ...
    $.ajax({
        ...
        dataType: 'json',
        success:function(response){
            $('#class_title').val(response.data.template_name);
...
<script type="text/javascript">
   ...
   $.ajax({
    ...
    dataType: 'json',
    success:function(response){
        $('#birthday_title').val(response.data.template_name);
