...
foreach ($students as $student) {
    ...
    <?php if (!empty($certificate[0]->background_image)) { ?>
        ...
        <div style="position:absolute; z-index:99999; font-weight:bold; top:34.5%; left:34%; font-size:20px;">
            <?php echo $student->firstname.' '.$student->middlename.' '.$student->lastname; ?>
        </div>

        <div style="position:absolute; z-index:99999; font-weight:bold; top:42%; left:34%; font-size:20px;">
        ...
        <div style="position:absolute; z-index:99999; font-weight:bold; top:27%; left:84%; font-size:20px;">
             <?php echo set_value('date', date($this->customlib->getSchoolDateFormat())); ?>
             
        </div>

        <div style="position:absolute; z-index:99999; font-weight:bold; top:26.5%; left:10%; font-size:20px;">
             <?php echo $student->admission_no; ?>
             
        </div>

        <div style="position:absolute; z-index:99999; font-weight:bold; top:49.5%; left:56%; font-size:20px;">
        <?php echo $student->class; ?>
             
        </div>


        <div style="position:absolute; z-index:99999; font-weight:bold; top:49.5%; left:84%; font-size:20px;">        
