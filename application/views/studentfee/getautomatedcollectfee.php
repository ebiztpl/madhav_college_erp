...
<!-- Custom code by hritik for Automated Percentage -->
...
<?php if ($total_amount > 0) {
   ...
   $newper =  ($newamount/$total_amount) * 100;
...
<!--End Custom code by hritik for Automated Percentage -->
<?php
    ...
    <div class="form-horizontal">
        <div class="col-lg-12">
            ...
            <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" autofocus="" class="form-control ritik_automated" id="amount" value="0">
                                <span class="text-danger" id="amount_error"></span>
                            </div>
                            <div class="col-sm-3">
                                <a class="form-control ritik_automated_button btn btn-success">Partial Amount</a>
                            </div>
                        </div>
...
<ul class="fees-list fees-list-in-box">
    ...
    if (($fee_value->due_date != "0000-00-00" && $fee_value->due_date != NULL) && (strtotime($fee_value->due_date) < strtotime(date('Y-m-d'))) && $amount_to_be_pay > 0) {
        ...
        if($newper !=  0){
        $amount_to_be_pay = ($amount_to_be_pay/100)* $newper;
        }
...
$(document).ready(function() {
    $('.ritik_automated').val(<?php echo $total_amount; ?>);
