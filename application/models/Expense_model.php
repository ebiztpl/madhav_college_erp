...
class Expense_model extends MY_Model
{
    ...
    {
        $this->db->select('expenses.id,expenses.date,expenses.session,expenses.p_info,expenses.name,expenses.created_by,expenses.approved_by,expenses.paid_by,expenses.payment_mode,expenses.invoice_no,expenses.amount,expenses.documents,expenses.note,expense_head.exp_category,expenses.exp_head_id,expenses.created_by_date,expenses.approved_by_date,expenses.page_no,expenses.exp_head_category,expenses.bankcash,expenses.e_account_id')->from('expenses');
    ...
    {
        $this->datatables
            ->select('expenses.id,expenses.date,expenses.name,expenses.invoice_no,expenses.amount,expenses.documents,expenses.note,expense_head.exp_category,expenses.exp_head_id,expenses.bankcash')
    ...
    public function staffget($id = null)
    {
        $this->db->select('staff.*,staff_designation.designation')->from('staff');
