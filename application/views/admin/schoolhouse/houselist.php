                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo $url ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Scheme Fees</label> <small class="req"> * </small>
                                    <input autofocus="" id="scheme_fees" name="scheme_fees" placeholder="" type="text" class="form-control"  value="<?php echo $scheme_fees; ?>" />
                                    <span class="text-danger"><?php echo form_error('scheme_fees'); ?></span>
                                </div>
...
foreach ($houselist as $house) {
    ?>
                                        <tr>
                                            ...
                                            <td class="mailbox-name"><?php echo $house['scheme_fees'] ?></td>
                                            ...
                                            <?php if ($this->rbac->hasPrivilege('fees_group_assign', 'can_view')) { ?>
                                                        <a data-placement="top" href="<?php echo base_url(); ?>admin/schoolhouse/assign/<?php echo $house['id'] ?>"
                                                           class="btn btn-default btn-xs" data-toggle="tooltip" title="Assign Schemes">
                                                            <i class="fa fa-tag"></i>
                                                        </a>
                                                    <?php } ?>
