                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <form role="form" action="<?php echo site_url('studentfee/searchpaymentreceipt') ?>" method="post" class="form-inline">
                                    <?php echo $this->customlib->getCSRF(); ?>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label>Receipt No.
                                            </label><small class="req"> *</small>
                                            <input autofocus="" id="reciptnumber" name="reciptnumber" placeholder="" type="text" class="form-control" value="<?php echo set_value('reciptnumber'); ?>" />
                                            <span class="text-danger"><?php echo form_error('reciptnumber'); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group align-text-top">
                                        <div class="col-sm-12">
                    ...
                    <?php
                    if (isset($feeList) || isset($feeListt)) {
                    ?>
                        <div class="ptt10">
...
<?php
                                        ...
                                        foreach($feeListt as $feeList){
                                         
                                            $res = json_decode($feeList->amount_detail);
                                                      $a      = (array) $res;
                                                  ...
                                                  foreach ($a as $key => $value) {
                                                    ...
                                                    if ($value->receipt_no == set_value('reciptnumber')) {
                                                        $sub_invoice_id = $key;
                                                 $record = $a[$key];
                                                 }
