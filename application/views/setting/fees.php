                        ...
                        <form role="form" id="fees_form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">                       
                                <div class="row">
                                    ...
                                    <!-- <div class="col-md-12">
                                            <div class="form-group row">
                                                <label class="col-sm-4">Library Per day Book Late Fine</label>
                                                <div class="col-sm-8">
                                                    <input type="number" name="lib_fine" id="lib_fine" class="form-control" value="<?php echo $result->lib_fine; ?>">
                                                    <span class="text-danger"><?php echo form_error('lib_fine'); ?></span>
                                                </div>
                                            </div>
                                        </div> -->
