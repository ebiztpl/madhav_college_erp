                                            ...
                                            if (empty($feearray)) {
                                                ...
                                                foreach ($feearray as $fee_key => $feeList) {
                                                   if($feeList->fee_category == "fees"){
                                                    ...
                                                    ?>
                                                    <tr  class="dark-gray" style="display:none !important">
...
if ($feeList->fine_amount != "") {
    ...
    <?php
                                                    ...
                                                    if (is_object($fee_deposits)) {
                                                        foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                            ?>
                                                            <tr class="white-td" style="display:none !important">
...
<span  class="text text-danger"><?php echo " + " . $currency_symbol.amountFormat($tr_fine_amount); ?></span>
    ...
    <?php
                                            ...
                                            <tr class="success">
                                            <td> 
                                                        <?php echo $feearray[0]->class ?>
                                                        </td>
                                                        <td>
                                                        <?php echo  $feearray[0]->section ?>
                                                        </td>
                                                <!-- <td align="left" ></td>
                                            ...
                                            if (empty($feearray)) {
                                                ...
                                                foreach ($feearray as $fee_key => $feeList) {
                                                   if($feeList->fee_category == "fees"){
                                                    ...
                                                    $total_balance_amount = $total_balance_amount + $feetype_balance;
                                                    ?>
                                                    <tr  class="dark-gray" style="display:none">
...
if ($feeList->fine_amount != "") {
    ...
    <?php
                                                    ...
                                                    if (is_object($fee_deposits)) {
                                                        foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                            ?>
                                                            <tr class="white-td" style="display:none">
                                                                <td colspan="5" class="text-right"><img src="<?php echo $this->media_storage->getImageURL('backend/images/table-arrow.png');?>" alt="" /></td>
                                                                <td class="text text-center">
                                                                    <?php echo $feeList->student_fees_deposite_id . "/" . $fee_deposits_value->inv_no; ?>
                                                                </td>
