                ...
                <div class="box box-info" style="padding:5px;">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right box-tools">
                            <a href="<?php echo site_url('admin/book/exportformatt') ?>">
...
foreach ($fields as $key => $value) {
    ...
    ?>
                    ...
                    <hr/>
                    <form action="<?php echo site_url('admin/book/importcopies/').$id ?>"  id="employeeform" name="employeeform" method="post" enctype="multipart/form-data">
                        <div class="box-body">
