...
if (set_value('created_by') == $drop->created_by) {
   ...
   <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type ="text" class="form-control" value="<?=$datapre?>" required name="book_code" />
                                        ...
                                        <div class="col-sm-1">
                                            <div class="form-group">
                                            <label for="exampleInputEmail1" style="color: white;">abcd</label>
                                                <a  href="<?php echo site_url('admin/book/getall') ?>" class="btn btn-warning btn-sm pull-right checkbox-toggle"><i class="fa fa-refresh"></i> 
                                                    Reset
    </a>
                                            </div>
                                        </div>
    ...
    <a  class="btn btn-warning btn-sm pull-right checkbox-toggle" href="<?php echo site_url('admin/book/getall') ?>" style="background-color:;margin-top: 24px;"><i class="fa fa-search"></i> 
                                                    View All Books
    </a>
   </div>  -->
   </div>   </div>
   <!-- search book  code -->   
    ...
    <div class="box-header ptbnull">
                        ...
                        <!-- <span style="margin-left: 20%;font-size:25px"><b>Total Book Copies</b> :<span style="color:green" class="totolbookcopies"><?= $totalcopies ?></span> </span> -->
...
<?php
 ...
 if( $value->lost == 1){
    echo  "<tr style=' background: rgb(135 175 187 / 62%)'>";
      }else{
        echo  "<tr>";
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">All Accession No.</h4>
        </div>
...
$(window).load(function() {
    setTimeout(function () {
            ...
            var arr = $cou.split('of');
             $('#newlyaappw').html('Total Records: '+arr[1]); 
        }, 500);
