...
$this->db->select('book_issues.*,libarary_members.id as lib_mem_id,libarary_members.member_id as member_idd,libarary_members.member_type')->from('book_issues');
$this->db->join('libarary_members', 'libarary_members.id = book_issues.member_id');
$this->db->where('book_issues.book_id',$value->book_listid);
$issuedat = $this->db->get();
$dattat = $issuedat->row();



if($dattat->member_type == 'student'){
    ...
    $this->db->where("id",$dattat->member_idd??'');
    $query = $this->db->get();
    $datt = $query->row();
    ...
    $row = '<a href="'.base_url().'/student/view/'.$dattat->member_idd.'">'.$datt->firstname??"".$datt->lastname??"".'</a>';

}elseif($dattat->member_type == 'teacher'){
  ...
  $row = '<a href="'.base_url().'/admin/staff/profile/'.$dattat->member_idd.'">'.$datt->name??"".$datt->surname??"".$dattt->designation??"".'</a>';
...
echo "<td>$row</td>";
echo "<td>".$dattat->member_type."</td>";
echo "<td>".$dattat->late_fine."</td>";
echo "<td>".$dattat->description."</td>";
