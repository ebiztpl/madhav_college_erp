...
class Pdf
{
   var $temppath;
    ...
    {
        // /home/u782112912/domains/madhavcollege.edu.in/public_html/erp/application/libraries/Pdf.php
        require_once '/var/www/vhosts/enrichapp.co.in/madhav.enrichapp.co.in/application/third_party/vendor/autoload.php';


        $mpdf = new \Mpdf\Mpdf(['tempDir' => $this->temppath,'mode' => 'utf-8', 'format' => 'A4', 'margin_left' => 0, 'margin_right' => 0, 'margin_top' => 0, 'margin_bottom' => 0]);
	...
	function load_en($param = NULL)
    {
        ...
        require_once '/var/www/vhosts/enrichapp.co.in/madhav.enrichapp.co.in/application/third_party/third_party/vendor/autoload.php';
