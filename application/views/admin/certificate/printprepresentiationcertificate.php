...
foreach ($students as $student) {
    ...
    <?php if (!empty($certificate[0]->background_image)) { ?>
        ...
        <div style="position:absolute; z-index:99999; font-weight:bold; top:33.5%; left:72%; font-size:20px;">
            <?php echo $student->firstname.' '.$student->middlename.' '.$student->lastname; ?>
        </div>

        <div style="position:absolute; z-index:99999; font-weight:bold; top:38.7%; left:26%; font-size:20px;">
        ...
        <div style="position:absolute; z-index:99999; font-weight:bold;top: 14.8%; left: 18.5%; font-size:12px;">
             <?php echo $student->admission_no; ?>
             
        </div>

        <div style="position:absolute; z-index:99999; font-weight:bold; top:43.4%; left:14%; font-size:20px;">
        ...
        <div style="position:absolute; z-index:99999; font-weight:bold; top:15.8%; left:83%; font-size:13px;">        
        <?php echo date("d-m-Y"); ?>
        </div>
