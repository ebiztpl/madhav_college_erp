<div class="col-md-2">
    <div class="box border0">
        <ul class="tablists">
            ...
            <li class="<?php echo set_SubSubmenu('schsettings/libarayfine'); ?>">
                <a class="<?php echo set_SubSubmenu('schsettings/libarayfine'); ?>" href="<?php echo site_url('schsettings/libarayfine') ?>">Library Setting</a>
            </li>
        </ul>
    </div>
</div><!--./col-md-3--> 