...
class Schsettings extends Admin_Controller
{
    ...
    public function savefees()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data                      = array(
                ...
                // 'lib_fine' => $this->input->post('lib_fine'),
            );
    ...
    public function libarayfine()
    {
        $this->session->set_userdata('top_menu', 'System Settings');
        $this->session->set_userdata('sub_menu', 'schsettings/index');
        $this->session->set_userdata('subsub_menu', 'schsettings/libarayfine');
        ...
        $query = $this->db->get();
        $data['library_setting'] = $query->result();


        $this->load->view('layout/header');
        $this->load->view('setting/libarayfine', $data);
        $this->load->view('layout/footer');
    }


    
    public function updatelibsetting()
    {
$this->form_validation->set_rules('student_book_count',"student book count", 'trim|integer|xss_clean');
$this->form_validation->set_rules('student_book_deadline',"student book deadline", 'trim|integer|xss_clean');
$this->form_validation->set_rules('student_late_fine',"student late fine", 'trim|integer|xss_clean');
$this->form_validation->set_rules('teacher_book_count',"teacher book count", 'trim|integer|xss_clean');
$this->form_validation->set_rules('teacher_book_deadline',"teacher book deadline", 'trim|integer|xss_clean');
$this->form_validation->set_rules('teacher_late_fine',"teacher late fine", 'trim|integer|xss_clean');
$this->form_validation->set_rules('guest_book_count',"guest book count", 'trim|integer|xss_clean');
$this->form_validation->set_rules('guest_book_deadline',"guest book deadline", 'trim|integer|xss_clean');
$this->form_validation->set_rules('guest_late_fine',"guest late fine", 'trim|integer|xss_clean');
      

$this->form_validation->set_rules('student_per_day',"student per day", 'trim|integer|xss_clean');
$this->form_validation->set_rules('teacher_per_day',"teacher per day", 'trim|integer|xss_clean');
$this->form_validation->set_rules('guest_per_day',"guest per day", 'trim|integer|xss_clean');

if ($this->form_validation->run() == true) {
            $data1 = array(
                'book_count' => $this->input->post('student_book_count'),
                'renewal_deadline' => $this->input->post('student_book_deadline'),
                'late_fine'	 => $this->input->post('student_late_fine'),
                'perday_perbook'	 => $this->input->post('student_per_day'),  
            );
            $data2 = array(
                'book_count' => $this->input->post('teacher_book_count'),
                'renewal_deadline' => $this->input->post('teacher_book_deadline'),
                'late_fine'	 => $this->input->post('teacher_late_fine'),
                'perday_perbook'	 => $this->input->post('teacher_per_day'),      
            );
            $data3 = array(
                'book_count' => $this->input->post('guest_book_count'),
                'renewal_deadline' => $this->input->post('guest_book_deadline'),
                'late_fine'	 => $this->input->post('guest_late_fine'),
                'perday_perbook'	 => $this->input->post('guest_per_day'),      
            );
            $this->db->where('type','student');
             $this->db->update('library_setting', $data1);
             $this->db->where('type','teacher');
             $this->db->update('library_setting', $data2);
             $this->db->where('type','guest');
             $this->db->update('library_setting', $data3);
            $this->session->set_flashdata('msg', '<div class="alert alert-success text-left">' . $this->lang->line('success_message') . '</div>');
            redirect('Schsettings/libarayfine');
        } 
            $this->session->set_userdata('top_menu', 'System Settings');
        $this->session->set_userdata('sub_menu', 'schsettings/index');
        $this->session->set_userdata('subsub_menu', 'schsettings/libarayfine');
