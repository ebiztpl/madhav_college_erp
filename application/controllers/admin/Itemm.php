...
class Itemm extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $insert_id = $this->itemm_model->add($data);

            $this->session->set_flashdata('msg', '<div class="alert alert-success text-left">' . $this->lang->line('success_message') . '</div>');
            redirect('admin/itemm/index');
        }

        $item_result      = $this->itemm_model->get();
        ...
        $this->load->view('admin/itemm/itemList', $data);
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('layout/header', $data);
            $this->load->view('admin/itemm/itemEdit', $data);
            $this->load->view('layout/footer', $data);
        } else {
            $data = array(
                'id'               => $id,
