            ...
            if (!empty($student_list) && isset($student_list)) {
                ...
                foreach ($student_list as $key => $value) {
                    ...
                    if ($result == "pass" && $session_status == "countinue") {
                        ...
                        $this->db->update('libarary_members',array( 'renewed'	 => 0,'renewed_session'=> $promoted_session));
                        ...
                        $this->db->where('member_id', $student_id);
                        $this->db->where('member_type','student');
                        $this->db->update('libarary_members',array( 'renewed'	 => 0,'renewed_session'=> $current_session));
