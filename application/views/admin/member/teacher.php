            ...
            <div class="col-md-12">              
                <div class="box box-primary" id="tachelist">
                    <div class="box-header ptbnull">
                        ...
                        <span style="margin-left: 10%;font-size:25px"><b>Total Members/Staff</b> :<span style="color:green" class="totolbookcopies"><span id="totalmembers"></span></span>/<?php echo count($teacherlist)  ?> </span>
                                    ...
                                    <?php if (empty($teacherlist)) {
                                        ...
                                        foreach ($teacherlist as $teacher) {
                                            ...
                                            <tr class="<?php echo $clsactive; ?>">
                                                ...
                                                <td><?php  if($teacher['libaray_card_date']??''){ echo ""; echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($teacher['libaray_card_date']??''));} ?></td>
                                                ...
                                                <td><?php if($teacher['created_at']){ echo date("d-m-Y", strtotime($teacher['created_at'])); } ?></td>
            ...
            <div class="modal-body">
                ...
                <form action="<?php echo site_url('admin/member/addteacher') ?>" id="add_member" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="name" class="form-control" name="library_card_no" id="library_card_no" required>
