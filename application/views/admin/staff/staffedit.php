...
?> --> <div class="col-md-3">
<div class="form-group"><label for="addhar_no" class="control-label">Adhar Card No.</label><small class="req"> *</small>
<input type="text" id="addhar_no" name="addhar_no" class="form-control" value="<?php echo set_value('addhar_no', $staff["addhar_no"]); ?>">
 <span class="text-danger"><p><?php echo form_error('addhar_no'); ?></p></span>
</div>
</div>
                            <div class="col-md-3"><div class="form-group"><label for="pan_no" class="control-label">PAN Card No.</label><small class="req"> *</small>
                                        <input type="text" id="pan_no" name="pan_no" class="form-control" value="<?php echo set_value('pan_no', $staff["pan_no"]); ?>"><span class="text-danger"><p><?php echo form_error('pan_no'); ?></p></span>
                                    </div>
                                </div>         
                            
                                <!-- <div class="col-md-3"><div class="form-group"><label for="date_of_reliving" class="control-label">Date of Reliving</label><small class="req"> </small>
                                        <input  id="date_of_leaving" name="date_of_leaving" class="form-control date" type="text" value="<?php echo set_value('date_of_leaving') ?>"><span class="text-danger"></span>
                                ...
                                <div class="col-md-3"><div class="form-group"><label for="nominee" class="control-label">Nominee Name</label><small class="req"> </small>
                                        <input type="text" id="nominee" name="nominee" class="form-control" value="<?php echo set_value('nominee', $staff["nominee"]); ?>"><span class="text-danger"></span>
                                    </div>
                                </div> 
                            
                                <div class="col-md-3"><div class="form-group"><label for="nominee_number" class="control-label">Nominee Contact Number</label><small class="req"> </small>
                                        <input type="number" id="nominee_number" name="nominee_number" class="form-control" value="<?php echo set_value('nominee_number', $staff["nominee_number"]); ?>"><span class="text-danger"></span>
                                    </div>
                                </div> 
                                        ...
                                        <div class="tshadow mb25 bozero">
                                            ...
                                            <div class="row around10">
                                                <?php if ($sch_setting->staff_epf_no) {?>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1"><?php echo $this->lang->line('cpf_no'); ?></label>
                                                            <input id="cpf_no" name="cpf_no" placeholder="" type="text" class="form-control"  value="<?php echo $staff["cpf_no"] ?>"  />
