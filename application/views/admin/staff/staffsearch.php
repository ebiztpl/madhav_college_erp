...
$userdata = $this->customlib->getUserData();
            ...
            if ($a == 1) {
                ...
                <a title="<?php echo $this->lang->line('edit'); ?>"  href="<?php echo base_url() . "admin/staff/edit/" . $staff["id"] ?>"><i class=" fa fa-pencil"></i></a>
                                                ...
                                                if ($this->rbac->hasPrivilege('books', 'can_delete') && ($staff["user_type"] != "Super Admin")) {  ?>
                                                               <a title="delete" class="check_confirm"  href="<?php echo base_url() . "admin/staff/delete/" . $staff["id"] ?>"><i class=" fa fa-trash"></i></a>
