...
class Audit extends Admin_Controller
{
    ...
    public function assests_depreciation()
    {
        $this->session->set_userdata('top_menu', 'Reports');
        $this->session->set_userdata('sub_menu', 'audit/assests_depreciation');
        $data['title']      = 'Assests Depreciation Report';
        $data['title_list'] = 'Assests Depreciation List';
        ...
        $data['cate'] =  $check ;
        $this->load->view('layout/header', $data);
        $this->load->view('admin/budget/assests_depreciation', $data);
        $this->load->view('layout/footer', $data);
    }
