...
foreach ($students as $student) {
    ...
    <div class="" style="position: relative; text-align: center; font-family: 'arial'; display:none;">
    ...
    <?php if (!empty($certificate[0]->background_image)) { ?>
        ...
        <div style="position:absolute; z-index:99999; font-weight:bold; top:49%; left:43%; font-size:20px;">
            <?php echo $student->firstname.' '.$student->middlename.' '.$student->lastname; ?>
        </div>

        <div style="position:absolute; z-index:99999; font-weight:bold; top:55.5%; left:8%; font-size:20px;">
        ...
        <div style="position:absolute; z-index:99999; font-weight:bold;top: 63.5%;left: 72%;; font-size:18px;">
        <?php echo date("d-m-Y", strtotime($student->admission_date)); ?>
             
        </div>

        <div style="position:absolute; z-index:99999; font-weight:bold;top: 38.4%; left: 10.5%; font-size:20px;">
             <?php echo $student->admission_no; ?>
             
        </div>

        <div style="position:absolute; z-index:99999; font-weight:bold; top:56%; left:45%; font-size:20px;">
        <?php echo $student->class; ?>
             
        </div>


        <div style="position:absolute; z-index:99999; font-weight:bold; top:56.3%; left:76%; font-size:20px;">        
        <?php echo date("Y", strtotime($student->admission_date)); ?>
        </div>

        <div style="position:absolute; z-index:99999; font-weight:bold; top:76.5%; left:13%; font-size:20px;">        
        <?php echo date("d-m-Y"); ?>
        </div>
      <?php if($student->image){   ?> 
        <div style="position:absolute; z-index:99999; font-weight:bold; top:23.6%; left:73.4%; ;">        
        <img src="<?php echo base_url().$student->image; ?>" style="height: 200px; width: 160px;"/>
        </div>
