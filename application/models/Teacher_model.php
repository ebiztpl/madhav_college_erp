...
class Teacher_model extends CI_Model
{
    ...
    public function getLibraryTeacher()
    {
        ...
        $this->db->select('staff.*, IFNULL(libarary_members.id,0) as `libarary_member_id`,libarary_members.libaray_card_date,libarary_members.created_at ,IFNULL(libarary_members.library_card_no,0) as `library_card_no`')->from('staff');
