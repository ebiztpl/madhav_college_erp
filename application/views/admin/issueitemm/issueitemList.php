...
<div class="content-wrapper">
    ...
    ?>
                                <a href="<?php echo site_url('admin/issueitemm/create') ?>" type="button" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> <?php echo $this->lang->line('issue_item'); ?></a>
                            <?php }
?>
                        </div>
                    </div><!-- /.box-header -->
...
<script type="text/javascript">
    ...
    $(document).on('click', '.btn-ok', function () {
        ...
        $.ajax(
                {
                    url: "<?php echo site_url('admin/issueitemm/returnItem') ?>",
                    type: "POST",
...
<script>
    ...
    'use strict';
    $(document).ready(function () {
        initDatatable('item-list','admin/issueitemm/getitemlist',[],[],100);
    });
} ( jQuery ) )
</script>