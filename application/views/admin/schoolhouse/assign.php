        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('admin/schoolhouse/assign/' . $id) ?>" method="post" class="row">
                    ...
                    <form method="post" action="<?php echo site_url('admin/schoolhouse/multipleassign') ?>" id="assign_form">
                        <?php
                        if (isset($resultlist)) {
                            ?>
                                                            ...
                                                            if (empty($resultlist)) {
                                                                ...
                                                                foreach ($resultlist as $student) {
                                                                    ...
                                                                    <tr>
                                                                        <td> 
                                                                            <?php
                                                                               if(($student['school_house_id'] == 0) || ($student['school_house_id'] == $id)){
                                                                                           

                                                                            if ($student['school_house_id'] == $id) {
                                                                                $sel = "checked='checked'";
                                                                            } else {
                                                                                $sel = "";
                                                                            }
                                                                            ...
                                                                            <input type="hidden" name="scheme" value="<?= $id ?>">
